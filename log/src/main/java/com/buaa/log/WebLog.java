...
/**
 * 日志清洗
 * 格式：IP 访问时间    请求资源     状态码    流量
 * 27.19.74.143 - - [30/May/2013:17:38:20 +0800] "GET /static/image/common/faq.gif HTTP/1.1" 200 1127
 * @author 李鹏
 * @time 2016年5月6日上午8:31:37
 */
public class WebLog extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		final Job job = new Job(conf, WebLog.class.getSimpleName());
	...
	public static void main(String[] args)  throws Exception{
		ToolRunner.run(new WebLog(), args);
	}
...
class LogParser {
	public static final SimpleDateFormat FORMAT = new SimpleDateFormat("d/MMM/yyyy:HH:mm:ss", Locale.ENGLISH);//英式
	public static final SimpleDateFormat dateformat1=new SimpleDateFormat("yyyyMMddHHmmss");//本地模式
